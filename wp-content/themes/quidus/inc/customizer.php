...
body {
background-color: <?php if ( get_theme_mod('quidus_color_background') == '' ) : echo esc_attr($white_color); else : esc_attr_e(get_theme_mod('quidus_color_background')); endif; ?>;
}
...
h6 a:hover,
.sticky-post {
	color:<?php //if ( get_theme_mod('quidus_color_special') == '' ) : echo esc_attr($special_color); else : esc_attr_e(get_theme_mod('quidus_color_special')); endif; ?> #984800 !important;
}
...
.site-content {
	width: <?php esc_attr_e(get_theme_mod('quidus_content_width_desktop') + get_theme_mod('quidus_right_sidebar_width')); ?>% !important;
}
...
.right-sidebar-wrapper {
	width: <?php esc_attr_e(get_theme_mod('quidus_right_sidebar_width')); ?>% !important;
}
...
.entry-header {
text-align: <?php //if ( get_theme_mod('quidus_post_title_align_left') == true ) : echo "left"; else : echo "center"; endif; ?> left !important;
}
